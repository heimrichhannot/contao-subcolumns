 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_module']['sc_modules'] = array('Select modules', 'If javascript is deactivated, save your changes before changing the order.');
$GLOBALS['TL_LANG']['tl_module']['sc_gap'] = array('Gap', 'Enter the gap between two columns in px. Default value is 12px.');
$GLOBALS['TL_LANG']['tl_module']['sc_gapdefault'] = array('User gap', 'Do you want to use a gap between two columns?');
